...
GloriaBassFigures = \figuremode {
  ...
  <7>2 \bo <[9 4]>8 <8 3> \bc <[5 \l]> <6> %5
  <6 4>4 \bo <[5] _+> r4. \bc <[6]>8
  r4. <6>8 r4. <[6 5]>8
  r \bo <[6 \l]> \bc <[6 5]>4 r4. <6>8
  <7>4 q r <4>8 <3>
  <9> <8> <4> <3> <9> <8> <4> <3> %10
  r4 <[6] 4>8 <7 [3]> r4. <[6]>8
  <7>4 q r2
  <6 4> <5 3>
  <6> \bo <[5\+]>4 \bc <[6]>
  \bo <[9] 7 _+> <8 \t \t> <2+> \bc <[3]> %15
  <6>2 r4. <6 5>8
  r <6\\> \bo <[6]> \bc <[7] 5> <_+>4. \bassFigureExtendersOn q8 \bassFigureExtendersOff
  <_+>4 <6> <_+>4. <[7 _+]>8
  <8> q q q q2
  <4\+>2 <6> %20
  <6\\>1
  ...
  r4. <6>8 <6 4> <6\\> <6> <6\\>
  r2 \bo <[7+ 4 2+]>8 <8 3> <4 2+> \bc <[5 3 \l]>
  <7 _+>2 <6\\ 4 3>4 <6>
  <6\\ 5>2 <[5+] _+>
  r4. <3>8 <_+> <3> q q %30
  r2 \bo <[7+ 4 2]>8 <8 3> <4 2> \bc <[5 3 \l]>
  r2 <6\\ 4 3>4 <6>
  <6 5>2 <_+>
  \bo <[5 3]>2. \bassFigureExtendersOn <5 3>4 \bassFigureExtendersOff
  <6 5>2. \bassFigureExtendersOn <6 5>4 \bassFigureExtendersOff %35
  <5 3>2. \bassFigureExtendersOn <5 3>4 \bassFigureExtendersOff
  <6 5>2. \bassFigureExtendersOn \bc <[6 5]>4 \bassFigureExtendersOff
  r1
  r4 <5> <6>2
  ...
  <6>2 <6\\ 5!>
  <6 4> <[5] _+>
  r4. \bo <[6 4]>8 <4\+ 2> <6> <6\\> <6!>
  <6 _+> <6> <6 4+> <6!> <6> <6\\> <6 4> <4\+ 2> %45
  <6> <\t> <6!> <6> <6\\> <6!> <6> <6\\>
  <8 3>1 \bassFigureExtendersOn
  <8 3>2 q8 q \bassFigureExtendersOff \bc <[_+ \l]>4
  r1
  r %50
  r
  <6>4 <6 4> r <6>
  ...
  r2 <[6 _+]>
  r <6\\>
  \bo <[6 \l \l]>4. <6>8 r4. <6\\>8 %65
  <5+ _+>4. <6 5 _+>8 r <6> <6\\ 5> \bc <[5+ _+ \l]>
  r2 <6 4 [_!]>
  <\t \t \t> <9 4>4 <[8 3]>
  r2 <6>
  <6> <5 3> %70
...
QuiTollisBassFigures = \figuremode {
  ...
  <6 4>4. <7 3>8 r2
  \bo <[7 \l \l]>8 <6>4. <7>8 <6>4.
  <7>8 <6>4. <7>4 <6 5>
  r <7 5+ _+> r2 %100
  <6\\> \bc <[5+ _+ \l]>
  r1
  r8 \bo <[7! 5 _+]> r4. \bc <[5 3 \l]>
  r1
  \bo <[6\\ \l]>2 \bc <[5+ _+]> %105
  r <6\\ 4 3>
  r <6 4 _!>
  r4 <7!> q <8 3>
  <4!> <3> r2
  \bo <[7 _! \l]>8 <6 \t>4. <7>8 <6!>4. %110
  <7 5!>8 <6>4. <7!>4 <6 5>
  <_!> <7 5+ _+> r2
  <6\\> \bc <[_+ \l \l]>
  r1
  r8 \bo <[7! \l]> r4. \bc <[5 3]> %115
  r1
  \bo <[6\\]>2 \bc <[_+]>
  r4 <6 4>8 <5 3> <9 4>4 <8 3>
...
QuoniamBassFigures = \figuremode {
  ...
  <6>2 q4 <[7] _+> %135
  <6>2 r4 <_+>8 <\t>
  <6>8 <5!> \bo <[9] 4> \bc <[8] 3> <6>4 \bassFigureExtendersOn q8 \bassFigureExtendersOff <6 5>
  <9 4> <8 _+> <[6]>4 <7 _+>4. <6 4>8
  <\t \t> <5 _+> <[6]>4 <7 _+>4. <6 4>8
  <\t \t> \bo <[5 _+]> <6>8.. \bc <[4\+ \l]>32 <6>8 <\t> <9 4> <8 3> %140
  r2 <6>8 q <6 4> <[5] _+>
  r2 \bo <[5 \l]>8 <6>4.
  <_+>4. <7 _+>8 r <6> q4
  q <6 _+> <6> q
  <6\\>8 <6> q <7 _+> r <7> <6>4 %145
  <7 _+>8 <5 3> <6 5> <7 _+> r <6> q \bc <[_+ \l]>
  r2.. <6>8
  <6\\> <6> q \bo <[_+ \l \l]> r4. <6>8
  <6>4. <6 5>8 r4. <7!>8
  r4 <6 5 _!>8 \bc <[_+ \l \l]> r2 %150
  r2.. <6>8
  <6\\>4 \bo <[6 \l]>8 \bc <[7 _+]> r4. <6>8
  <6\\>4. \bo <[6 5]>8 r4 \bc <[6 \l]>
  <4>8 <\t> <6 4>4 <4>8 <\t> <6 4>4
  <4>8 <\t> <6 4> <[2]> <6> <6_!> <6 5> <4\+ 2> %155
  <6> q r <[6]> <5> <6> r <7>
  <6 4> \bo <[5] _+> \bc <[6]>4 <7 5>4. <6 4>8
  <\t \t> <[5 3]> <6>4 <7>4. <6 4>8
  <\t \t>4 \bo <[5] _+> r8 <6> \bc <[7]>4
  ...
  <6>4 \bo <[8]>8 \bc <[7]> <6> r4.
  <5>4 <5>4. <6>8 <_+>4 %180
  <6>2 <10>4 <6>
  <2+> \bo <8 [6] _+>8 \bc <7 [5] \t> <6 4> <\t \t> <5 3>4 \bassFigureExtendersOn
...
CredoBassFigures = \figuremode {
  ...
  <[6 5]>1
  r4 <4 2>8 <6\\> r2
  \bo <[6 5]>4. <7 _+>8 r4 \bc <[6 5]>
  r2 <5>4 \bo <[6]>8 \bc <[_+]> %5
  r1
...
BenedictusBassFigures = \figuremode {
  r2 <4>8 <3> <6 4> <6>
  r8 <[6]> <6>4 <6 4>8 <5 3> \bo <[6 4]> \bc <[7 5]>
  r <6>4. <5> <5>8
  <6 4>4. <7 [3]>8 <\t \t>4 <8 3>
  r1 %5
  r
