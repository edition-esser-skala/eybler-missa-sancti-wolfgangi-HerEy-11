...
KyrieViolinoII = {
  \relative c' {
    ...
    g g g g f f %10
    g g a a b( g)
    f[ f e] c16.\f d32 e16. f32 g16. a32
    b8\sfp c, c c c c
    r c c c c c
    r g' g g g g %15
    r f-! f-! f(\cresc g a)
    ...
    c\ff f8 f f f f f16
    f8 r r4 d8(\p b)
    a16(\pp c f c) a( c f c) b( c e c) %25
    a8 r f'16_[( g a b] c\cresc d e f)
    g4~\sf g8 e16( c) b( g e b)
    a(\p e' g e) a,( d f d) b( d g d)
    ...
    d d d c b b
    g\p g f f f es
    b'16\f b, b' b b( b') b( g) g( f) f( es) %55
    es( d) d( c) c( b) b( g') g( f) f( es)
    es( d) d( c) c( b) b( g') g( f) f( es)
    es( d) d( c) b4 <b, f' d'>8 r\fermata \markCritnote
    R2.
    des8\pp des des des des des %60
    des4 c r
    es8 es es es es es
    es4 d! r
    f8\cresc f f f f f
    ...
    <d' f>2.:8\f
    <e g>2.:16\ff %95
    <d f>4 \parOn a-\parenthesize-! \parOff f-\parenthesize-!
    d a f'
    d8(\p b a b a b)
...
GloriaViolinoII = {
  \relative c' {
    ...
    <a e' a>8 r <a e' cis'> r <a fis' d'> d16.[ e32] fis16. g32 a16. fis32
    d8 fis4\p a8 r g4 fis8
    ...
    h e32 fis g16 e d fis cis e d8 r r a\pp
    ...
    cis e a a, h8 gis' a, e'16. d32 cis16. d32 e16. cis32
    ...
    fis,8 cis'16( a) a( fis) fis( cis) cis8\pp h h h
    ...
    e a d d a,8 e' d16( a) a( fis) fis( d) d( a)
    a8\pp g' g g fis fis fis fis
    g g g g fis\f g16 a h cis d e
    ...
    <cis e>\ff q q q q q q q <d fis> q q q <d g!> <d g> q q
...
QuoniamViolinoII = {
  \relative c' {
    ...
    d cis h h a r r e( %125
    d) r r d( e) r r e'(
    d) a'-! fis8.\trill e32 d a'8 a, r4
    <d fis, a,>8. cis16 d8 e <fis a, d,>4 d8 a
    g fis e cis d4 r8 a'(
    g) r r e'( d) r r \override TupletNumber.stencil = ##f \tuplet 3/2 8 { d,16 fis a } %130
    d8 cis d e d \tuplet 3/2 8 { d16 cis h } a8 \tuplet 3/2 8 { g16 fis e }
    \appoggiatura fis d'8. cis16 d8 e <fis a, d,>4 d8 a
    ...
    e'8 e,16. fis32 gis16. a32 h16. gis32 e8 h4\p a8
    a8. h16 gis8 gis~ gis h4 a8
    ...
    d8. e16 cis8 a\f a'~ \tuplet 3/2 8 { a16 h a g a g fis g fis }
    g8 \tuplet 3/2 8 { g'16 a g fis g fis e fis e } a8 \tuplet 3/2 8 { cis,16 h cis d cis d e d e } %160
    fis8 d4 cis8 d \tuplet 3/2 8 { d,16\ff cis d fis e fis a g a }
    \tuplet 3/2 8 { d cis d fis, a d fis e fis a, d fis <e cis> q q q q q q q q q q q }
    d4 r8\tuplet 3/2 8 { a16 g fis } e4 r8 \tuplet 3/2 8 { cis'16 d e }
    ...
    fis8 d32( e fis g) a8-! d,-! cis2\fermata %170
    r4 d,\f g h \noBreak
    cis,2\trill d
    R1*2
    a'4 fis h g %175
    ...
    d8 r r4 r8 \mvDlll a,16(\pp cis) cis([ e)] e( a)
...
EtResurrexitViolinoII = {
  \relative c' {
    ...
    a4\ff r8 \tuplet 3/2 8 { a16( h cis) } d4 r8 d32( e f g)
    a4 r8 \tuplet 3/2 8 { a16( h! cis!) } d4 r8 d32( e f g)
    a4 r r2
    R1*9 %164
